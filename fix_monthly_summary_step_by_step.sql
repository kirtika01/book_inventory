-- Step-by-step fix for monthly expenses summary
...
FROM pg_constraint 
WHERE conrelid = 'monthly_expenses_summary'::regclass;
...
-- STEP 6: Create the upsert function
...
-- STEP 7: Create the get available months function
...
-- STEP 8: Create the initialize function
...
-- STEP 10: Verify the data was populated
SELECT 
    month_year,
    total_fixed_amount,
    total_expenses,
